...
<form class='mb-3'>
    <input type='text' name='q' class='form-control' placeholder='Buscar medicamento...' value='<?= htmlspecialchars($_GET["q"] ?? "") ?>'>
</form>
...
<?php foreach ($meds as $m): ?>
    ...
    <a href='editar_med.php?id=<?= $m['id_medicamento'] ?>'class='btn btn-sm btn-warning'>Editar</a>
    <a href='?eliminar=<?= $m['id_medicamento'] ?>'class='btn btn-sm btn-danger' onclick='return confirm("¿Eliminar?")'>Eliminar</a>
</td>
</tr>
